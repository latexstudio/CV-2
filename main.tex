...
\begin{factlist}
  ...
  {{\footnotesize \begin{tabular}{ l  r }
   ...
   {{\footnotesize \begin{tabular}{ l  r }
	...
	\item{GraphicDesign}
	{{\footnotesize \begin{tabular}{ l  r }
			Photoshop & \progressbar[emptycolor =White, filledcolor =RedOrange,  subdivisions=0]{1} \\
	 ...
	 \item{3D \& CAO}
	 {{\footnotesize \begin{tabular}{ l  r }
	 		3DsMax & \progressbar[emptycolor =White, filledcolor =RedOrange,  subdivisions=0]{0.7} \\
	 ...
	 {{\footnotesize \begin{tabular}{ l  r }
	 		...
	 		Java & \progressbar[emptycolor =White, filledcolor =RedOrange,  subdivisions=0]{0.86} \\
	 	\end{tabular}}}
