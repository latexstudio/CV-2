...
\begin{factlist}
  ...
  {{\footnotesize \begin{tabular}{ l  r }
   ...
   {{\footnotesize \begin{tabular}{ l  r }
	...
	\item{GraphicDesign}
	{{\footnotesize \begin{tabular}{ l  r }
			Photoshop\hspace{3mm} & \progressbar[emptycolor =White, filledcolor =RedOrange,  subdivisions=0]{1} \\
			Illustrator & \progressbar[emptycolor =White, filledcolor =RedOrange,  subdivisions=0]{0.9} \\
		\end{tabular}}}
		
	 
	 \item{3D \& CAO}
	 {{\footnotesize \begin{tabular}{ l  r }
	 		3DsMax\hspace{7mm} & \progressbar[emptycolor =White, filledcolor =RedOrange,  subdivisions=0]{0.7} \\
	 		Zbrush & \progressbar[emptycolor =White, filledcolor =RedOrange,  subdivisions=0]{0.93} \\
	 		Vue & \progressbar[emptycolor =White, filledcolor =RedOrange,  subdivisions=0]{0.86} \\
	 	\end{tabular}}}
	 	
	 \item{Programming}
	 {{\footnotesize \begin{tabular}{ l  r }
	 		C & \progressbar[emptycolor =White, filledcolor =RedOrange,  subdivisions=0]{0.9} \\
	 		C++ & \progressbar[emptycolor =White, filledcolor =RedOrange,  subdivisions=0]{0.7} \\
	 		Java\hspace{13mm} & \progressbar[emptycolor =White, filledcolor =RedOrange,  subdivisions=0]{0.86} \\
	 	\end{tabular}}}
